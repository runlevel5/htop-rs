...
| C htop | htop-rs | Description |
|--------|---------|-------------|
| `CRT.c/h` | `src/ui/crt.rs` | ncurses abstraction |
...
| `Meter.c/h` | `src/ui/meter.rs` | All meter types |
| `FunctionBar.c/h` | `src/ui/function_bar.rs` | F-key bar |
| `Action.c/h` | Part of `screen_manager.rs` | Key handlers |
...
| Header/meters | `Header.c`, `Meter.c` | `ui/header.rs`, `ui/meter.rs` |
