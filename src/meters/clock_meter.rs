...
//!
//! This meter demonstrates direct use of the ncurses-rs pure Rust API
//! instead of the compatibility shim.
        ...
        match self.mode {
            ...
            _ => {
                ...
                crt.with_window(|win| {
                    ...
                    let _ = win.addstr("Time: ");

                    let _ = win.attrset(value_attr);
                    let _ = win.addstr(&self.time_str);
                });
            }
        }
    }
